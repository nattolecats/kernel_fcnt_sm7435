...
enum pon_restart_reason {
	...
	PON_RESTART_REASON_SELINUX_PERMISSIVE	= 0x21,
	PON_RESTART_REASON_SELINUX_ENFORCING	= 0x22,
	// Nagoya LIMITED For SELinux by sunning at 2023-12-26 end 
	PON_RESTART_REASON_USER_SPACE_REQUEST = 0x31,
	PON_RESTART_REASON_OFFCHARGE = 0x32,
	PON_RESTART_REASON_FORCENORMAL = 0x33,
	PON_RESTART_REASON_USERS_REQUEST = 0x34,
	PON_RESTART_REASON_SIM_IS_ADDED = 0x35,
	PON_RESTART_REASON_REPAIR = 0x36,
/*	PON_RESTART_REASON_SDDL = 0x37, */
/*	PON_RESTART_REASON_MAKERCMD = 0x38, */
/*	PON_RESTART_REASON_UFS_FW_REFRESH = 0x39, */
	PON_RESTART_REASON_SHIPMODE = 0x3A,
	PON_RESTART_REASON_OTHER_REQUEST1 = 0x41,
	PON_RESTART_REASON_OTHER_REQUEST2 = 0x42,
};
